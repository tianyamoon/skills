...
description: 行业周期方法论-股票。通用行业周期分析与股票研究技能，用于构建、复用和应用第一性原理与顶级机构方法论，支持股票视角的行业阶段判断、资本周期分析、估值与预期校验、历史复盘、AI与跨行业映射，以及把研究结果组织成顶级基金风格的最终输出。用于“股票行业周期”“周期研究”“股票周期研究”“行业周期方法论-股票”“周期方法论-股票”等请求，或需要明确区分“过程层”和“结果层”时使用。
---
