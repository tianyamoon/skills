...
description: 通用行业周期分析技能，用于构建、复用和应用第一性原理与顶级机构方法论，支持行业阶段判断、资本周期分析、估值与预期校验、历史复盘、AI与跨行业映射，以及把研究结果组织成顶级基金风格的最终输出。用户在研究或比较行业周期、沉淀可复用分析框架、升级研究模板、撰写像股东信、季度信、年报一样有序的研究总结，或需要明确区分“过程层”和“结果层”时使用。
---
